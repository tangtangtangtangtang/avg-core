...
const Image = tools.componentify('Image', {
  createNode() {
  ...
  mountNode(props) {
    ...
    tools.setValue.call(node, 'rectangle', props.rectangle);
  ...
  updateNode(prevProps, props) {
    ...
    tools.updateValue.call(node, 'rectangle', prevProps.rectangle, props.rectangle);
