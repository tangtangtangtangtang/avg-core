  ...
  render() {
    ...
    return (
      <Transition ref={transLayer => (this.transLayer = transLayer)}>
        <Layer>
          {this.state.center
            ? <Image width={this.props.picWidth} height={this.props.picHeight} src={this.state.center} x={Math.round(width * 0.5)} y={height} anchor={[0.5, 1]} key='center' /> : null}
          {this.state.left
            ? <Image width={this.props.picWidth} height={this.props.picHeight} src={this.state.left} x={Math.round(width * 0.25)} y={height} anchor={[0.5, 1]} key='left' /> : null}
          {this.state.right
            ? <Image width={this.props.picWidth} height={this.props.picHeight} src={this.state.right} x={Math.round(width * 0.75)} y={height} anchor={[0.5, 1]} key='right' /> : null}
        </Layer>
      </Transition>
    );
  }
